...
@section('isihalaman')
    ...
    <p>
    <h4>Perpustakaan USU</h4>
        UPT Perpustakaan Universitas Sumatera Utara [USU] sebagai salah satu perpustakaan perguruan tinggi negeri di Indonesia 
    ...
    <p>
		...
		ditiap tahunnya yaitu dengan rata-rata 5,18 % pertahun. UPT Perpustakaan USU sampai 10 Oktober 2018 
